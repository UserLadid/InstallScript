...
sudo -H pip3 install -r https://github.com/UserLadid/Odoo-14.0/raw/${OE_VERSION}/requirements.txt
...
sudo git clone --depth 1 --branch $OE_VERSION https://www.github.com/UserLadid/Odoo-14.0 $OE_HOME_EXT/
